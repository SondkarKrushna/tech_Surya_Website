...
const Navbar = () => {
    ...
    return (
        <nav className="bg-transparent text-white fixed top-0 left-0 w-full z-[100]">
            <div className="max-w-[1400px] px-6 md:px-10 mx-auto">
                <div className="flex justify-between items-center h-24">
                    <div className="flex items-center">
                        <Link to="/" onClick={() => handleLinkClick('/', 'HOME')} className="bg-white rounded-full px-8 py-2.5 inline-flex items-center justify-center shadow-md">
                            <img className="h-6 md:h-8 object-contain" src="/ts-logo.png" alt="Tech Surya Logo" />
                        </Link>
                    </div>
